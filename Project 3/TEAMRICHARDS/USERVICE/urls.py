...
urlpatterns = [
    ...
    url(r'^activity/create_request/$', views.ActivityCreateRequest.as_view(), name='activity-Create'),
    url(r'^activity/create_offer/$', views.ActivityCreateOffer.as_view(), name='activity-Create'),
    ...
    url(r'^carpool/create_request/$', views.CarpoolCreateRequest.as_view(), name='carpool-Create'),
    url(r'^carpool/create_offer/$', views.CarpoolCreateOffer.as_view(), name='carpool-Create'),
    ...
    url(r'^tutor/create_request/$', views.TutorCreateRequest.as_view(), name='tutor-Create'),
    url(r'^tutor/create_offer/$', views.TutorCreateOffer.as_view(), name='tutor-Create'),
    ...
    url(r'^textbook_trading/create_request/$', views.Textbook_TradingCreateRequest.as_view(), name='textbook-Create'),
    url(r'^textbook_trading/create_offer/$', views.Textbook_TradingCreateOffer.as_view(), name='textbook-Create'),
